...
namespace PHPSTORM_META {
    ...
    */
    ...
    override(\config(), map([
            ...
            'filesystems.links./Users/noquierouser/Desarrollos/Descartados/elecciones.pichilemutv/public/storage' => 'string',
...
'filesystems.disks.s3.url','filesystems.disks.s3.endpoint','filesystems.disks.s3.use_path_style_endpoint','filesystems.disks.s3.throw','filesystems.links./Users/noquierouser/Desarrollos/Descartados/elecciones.pichilemutv/public/storage',
...
'filament.admin.resources.alcaldes.index','filament.admin.resources.concejals.index','filament.admin.resources.locals.index','filament.admin.resources.mesas.index','filament.admin.resources.pactos.index',
'filament.admin.resources.partidos.index','filament.admin.resources.resultados-alcaldes.index','filament.admin.resources.resultados-concejals.index','filament.admin.resources.subpactos.index','livewire.update','livewire.upload-file','livewire.preview-file',
'storage.local',);
        registerArgumentsSet('views', 
'components.candidate-name','components.layouts.app','livewire.alcaldes','livewire.concejales','livewire.dhondttest',
'livewire.resultados','livewire.talonador','volt-livewire::alcaldes','volt-livewire::concejales','volt-livewire::dhondttest',
'volt-livewire::resultados','volt-livewire::talonador','welcome','filament-actions::badge-action','filament-actions::badge-group',
